...
Serializer.prototype.registerOverride = function(classLabel, fnSerialize, fnDeserialize) {
 ...
 *
 */
Serializer.prototype.indexClasses = function(ns) {
...
Serializer.prototype.findClasses = function(ns) {
    var result = {};
 ...
 *
 */
Serializer.prototype.getLabelForClass = function(obj) {
...
Serializer.prototype.getClassForLabel = function(classLabel) {
    var result;
...
Serializer.prototype.serialize = function(obj, context) {
...
Serializer.prototype.serializeRec = function(obj, context) {
    var result;
    ...
    if (state) {
        ...
        var isPrimitiveObject = function(obj) {
            var result = !!obj || Object.toString.call(obj) === '[object Number]' ||
 ...
 *
 */
Serializer.prototype.serializeAttrs = function(obj, context, proto) {
    var result = {};
    var parent = result;
    ...
    keys.forEach(function(k) {
        ...
        var compVal = proto[k];
        var isEqual = isequal(val, compVal) || (val === null && compVal === null);
        //console.log('is equal: ', isEqual, 'val: ', val, 'compVal: ', compVal);
        if (isEqual) {
            return;
        }
 ...
 *
 */
Serializer.prototype.deserialize = function(graph) {
...
Serializer.prototype.deserializeRef = function(attr, idToState, idToObj) {
    var ref = attr.ref;
...
Serializer.prototype.deserializeState = function(id, idToState, idToObj) {
