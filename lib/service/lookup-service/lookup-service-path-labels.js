...
var LookupServicePathLabels = function(source) {
    LookupServiceBase.call(this);

    this.initialize(source);
};
// inherit
LookupServicePathLabels.prototype = Object.create(LookupServiceBase.prototype);
// hand back the constructor
LookupServicePathLabels.prototype.constructor = LookupServicePathLabels;

LookupServicePathLabels.prototype.initialize = function(lookupServiceBase) {
    this.lookupServiceBase = lookupServiceBase;
};

LookupServicePathLabels.prototype.lookup = function(paths) {
