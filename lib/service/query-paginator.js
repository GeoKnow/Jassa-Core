 ...
 *
 */
var QueryPaginator = function() {
    this.initialize();
};

QueryPaginator.prototype.initialize = function(query, pageSize) {
    this.query = query;
...
QueryPaginator.prototype.getPageSize = function() {
    return this.pageSize;
};

// Returns the next limit and offset
QueryPaginator.prototype.next = function() {
