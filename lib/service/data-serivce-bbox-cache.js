...
DataServiceBboxCache.prototype.runWorkflow = Promise.method(function(bounds) {
    var rootNode = this.quadTree.getRootNode();
 ...
 *
 */
DataServiceBboxCache.prototype.runTiledWorkflow = Promise.method(function(bounds) {
    var self = this;
