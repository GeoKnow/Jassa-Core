...
var ListServiceIndexSubString = Class.create(ListService, {
    initialize: function(delegate, filterSupplierFn, countThreshold) {
    ...
    getBestCandKey: function(str) {        // Check if any of the strToItem arrays matches
        ...
        cands.forEach(function(cand) {
            ...
            if(promise.isFulfilled()) {
                var v = promise.value();
                var n = v.length;
                if(bestCandSize == null || n < bestCandSize) {
                    bestCandKey = cand;
                    bestCandSize = n;
                }
    ...
    fetchCount: function(str, itemLimit, rowLimit) {
        ...
        if(bestCandKey != null) {
            ...
            result = promise.then(function(entries) {
                ...
                var r = filtered.length;
                return r;
            });
        } else {
            result = this.delegate.fetchCount(str, this.itemLimit, this.rowLimit);
        }
