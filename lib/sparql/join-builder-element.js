...
// constructor
var JoinBuilderElement = function(rootElement, rootElementVars, rootAlias, defaultRootJoinVars) {
    this.initialize(rootElement, rootElementVars, rootAlias, defaultRootJoinVars);
};

JoinBuilderElement.prototype.initialize = function(rootElement, rootElementVars, rootAlias, defaultRootJoinVars) {
...
JoinBuilderElement.prototype.getRootNode = function() {
    return this.rootNode;
};

JoinBuilderElement.prototype.getJoinNode = function(alias) {
...
JoinBuilderElement.prototype.getState = function(alias) {
    return this.aliasToState[alias];
};

JoinBuilderElement.prototype.getElement = function(alias) {
    var state = this.aliasToState[alias];
    var result = state ? state.getElement() : null;
    return result;
};

JoinBuilderElement.prototype.addVars = function(vars) {
...
JoinBuilderElement.prototype.createTargetState = function(targetAlias, sourceVarMap, sourceJoinVars, targetElement, oldTargetVars, targetJoinVars) {
...
JoinBuilderElement.prototype.addJoin = function(joinType, sourceAlias, sourceJoinVars, targetElement, targetJoinVars, targetAlias) {
...
JoinBuilderElement.prototype.getElementsRec = function(node) {
    var resultElements = [];
...
JoinBuilderElement.prototype.getElements = function() {
...
JoinBuilderElement.prototype.getAliasToVarMap = function() {
    var result = {};
...
JoinBuilderElement.prototype.create = function(rootElement, rootAlias, defaultJoinVars) {
 ...
 * 
 */
JoinBuilderElement.prototype.createWithEmptyRoot = function(varNames, rootAlias) {
