...
//var uniqTriples = require('../uniqTriples');
//r getVarName = require('../get-var-name');
var GenSym = require('./GenSym');
var GeneratorBlacklist = require('./GeneratorBlacklist');
var HashBidiMap = require('../util/HashBidiMap');
var fnNodeEquals = require('../util/ObjectUtils'); // node-equals
