...
Binding.create = function(varNameToNode) {
    ...
    var tmp = {};
    varNameToNode.map(function(node, vStr) {
        tmp[vStr] = {
...
Binding.prototype = {
    ...
    entries: function() {
        var tmp = [];
        this.varNameToEntry.forEach(function(val) {
            tmp.push(val);
        });
    ...
    getVars: function() {
        ...
        this.varNameToEntry.forEach(function(entry) {
            result.push(entry.v);
        });
