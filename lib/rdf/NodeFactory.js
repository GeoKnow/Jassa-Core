...
var NodeUri = require('./node/Node_Uri');
var NodeBlank = require('./node/Node_Blank');
var NodeLiteral = require('./node/Node_Literal');
...
var NodeFactory = {
    ...
    createTypedLiteralFromValue: function(val, typeUri) {
        ...
        return new NodeLiteral(literalLabel);
    },
