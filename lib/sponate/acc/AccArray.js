...
var BindingMapperIndex = require('../bindig_mapper/BindingMapperIndex');
var Acc = require('./Acc');
...
var AccFn = Class.create(Acc, {
    ...
    initialize: function(subAgg, indexBindingMapper) {
        ...
        this.subAgg = subAgg;
        this.fnIndex = indexBindingMapper || new BindingMapperIndex();

        this.subAccs = [];
    },

    accumulate: function(binding) {
        var index = this.indexBindingMapper(binding, this.i++);
