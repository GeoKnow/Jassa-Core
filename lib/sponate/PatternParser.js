...
var AggregatorLiteral = require('./aggregator/AggregatorLiteral');
var AggregatorObject = require('./aggregator/AggregatorObject');
var AggregatorMap = require('./aggregator/AggregatorMap');
var AggregatorCustomAgg = require('./aggregator/AggregatorMap');
var AggregatorRef = require('./aggregator/AggregatorRef');

var AccumulatorFactoryFn = require('./AccumulatorFactoryFn');

/**
 * A 'pattern' is a type of specification for an aggregator
 *
 */
var PatternParser = Class.create({
    ...
    parseArrayConfig: function(config) {
        ...
        if (hasId) {
            ...
            // Expects a AggregatorLiteral
            var idPattern = subPattern.getPattern(idAttr);
            var idExpr = idPattern.getExpr();
            result = new AggregatorMap(idExpr, subPattern, true);
    ...
    parseArrayRef: function(config) {
        ...
        var result = new AggregatorRef(config);
        return result;
    },
    ...
    parseLiteral: function(val) {
        ...
        var result = new AggregatorLiteral(expr);
        return result;
    },
    ...
    parseObject: function(val) {
        ...
        var result = new AggregatorObject(attrToPattern);
        return result;
    },
