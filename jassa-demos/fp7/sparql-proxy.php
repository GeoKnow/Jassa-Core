...
// Proxy settings (http://php.net/manual/de/function.curl-setopt.php)
$httpProxyUrl = null;
$httpProxyUserPwd = null; // Format: username:password
...
if($httpProxyUrl) {
    curl_setopt($ch, CURLOPT_PROXY, $httpProxyUrl);

    if($httpProxyUserPwd) {
        curl_setopt($ch, CURLOPT_PROXYUSERPWD, $httpProxyUserPwd);
    }
}
